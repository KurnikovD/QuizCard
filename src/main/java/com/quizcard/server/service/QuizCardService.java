...
import com.example.QuizCard.dto.*;
...
public class QuizCardService {
    ...
    public void start(String quizId) {
        ...
        roundDtos.forEach(roundDto -> roundDto.setDesk(topicRepository.findByRound_Id(roundDto.getId()).stream().map(this::toDeskDto).toList()));
    }

    public DeskDto toDeskDto(Topic topic) {
    ...
    public CostDto toCostDto(Question question) {
    ...
    public AnswerDto doAnswerDto(Question it) {
    ...
    public CatDto toCatDto(Question it) {
